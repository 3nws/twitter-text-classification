...
pipeline = make_pipeline(StandardScaler(with_mean=False), MNB)
...
# pickle.dump(MNB, open('./models/MNB_model_pipeline', 'wb'))
# pickle.dump(tfidf, open('./vector/tfidf_vectorizer_mnb_pipeline', 'wb'))